package com.company.JavaComPort;
...
// Inner классы
    ...
    public class Form extends JFrame{
        ...
        private void initComponents(){
            ...
            // добавление метки состояния JavaComPort порта
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if(serialPort.isOpened() == true) {
                try {
                    ...
                    label1.setText(comPort + " Is close");
                    label1.setForeground(Color.red);
                    System.out.println("JavaComPort остановлен");
                    readData = "";
                } catch (SerialPortException ex) {
            ...
            if(pOpen == true){
                if(event.isRXCHAR() && event.getEventValue() > 0){
                    ...
                    try {
                        ...
                        // Байты из буфера JavaComPort в матрицу arrReadComByte
                        arrReadComByte = serialPort.readBytes(comCount);
                        // Вход если в буфере JavaComPort имеются данные
                        if(comCount > 1){
...
// Метод Main
    ...
    public static void main(String[] args) {
        ...
        // Вывод списка JavaComPort портов
        nbport();
        // Запуск формы
